...
# Question 2: a method called del_del
  ...
  # del_del("xyz") => "xyz"
describe "del_del" do
  it "deletes any wayward instances of 'del' within a string" do
    expect('abdelcd'.del_del).to yield 'abcd'
  end
  it "returns the original string if 'del' is not found" do
    expect('xyz'.del_del).to yield 'xyz'
  end
end
...
describe "missing_char" do
  it "removes a given character from a string based on index" do
  end
  it "returns RuntimeError if a string is not entered" do
  end
end
...
describe "near_hundred" do
  it "yields 'true' if a number is within the range of 90 - 99" do
  end
  it "yields 'false' if a number is not within the range of 90 - 99" do
  end
end
...
describe "back_around" do
  it "replaces the first character in a string with the last" do
  end
end
